...
CREATE TABLE IF NOT EXISTS `admins` (
  ...
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商家管理人员';
...
CREATE TABLE IF NOT EXISTS `cate` (
  ...
  PRIMARY KEY (`cid`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='食品栏目列表';
...
CREATE TABLE IF NOT EXISTS `food` (
  ...
  PRIMARY KEY (`fid`)
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='食品表';

/*!40000 ALTER TABLE `food` DISABLE KEYS */;
INSERT INTO `food` (`fid`, `foodname`, `cid`, `images`, `detail`, `heartnum`, `badnum`, `price`, `sales`, `status`, `discount`, `monthsales`) VALUES
	(1, '超级至尊比萨（芝心）', 1, 'images/yh01.jpg', '腊肉肠、意式香肠、火腿、五香牛肉、五香猪肉、搭配菠萝、蘑菇、洋葱、青椒、黑橄榄等蔬菜水果，如此丰盛馅料，口口都是令人满足的好滋味。 主要原料:面团、牛肉粒、猪肉粒、火腿、腊肉肠、芝士、蔬菜、菠萝、黑橄榄', 0, 0, 108, 61, 1, 1, 0),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `sex` int(11) DEFAULT NULL COMMENT '1代表男，2代表女',
...
INSERT INTO `users` (`uid`, `username`, `passwd`, `tel`, `address`, `photo`, `regtime`, `sex`, `consume`, `mgid`) VALUES
	(1, '18328812306', '202cb962ac59075b964b07152d234b70', '', '', NULL, '', NULL, 0, 1);
